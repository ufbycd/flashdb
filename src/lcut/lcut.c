		...
		const char *fcname, const char *fname)
{
	...
	if(expected != actual)
	{
		FILL_IN_FAILED_REASON(tc, fname, fcname, lineno, "expected<%d> : actual<%d>",
				expected, actual);
	}
}
		...
		const char *fcname, const char *fname)
{
	...
	if(expected == actual)
	{
		FILL_IN_FAILED_REASON(tc, fname, fcname, lineno, "not expected<%d> : actual<%d>",
				expected, actual);
	}
}
